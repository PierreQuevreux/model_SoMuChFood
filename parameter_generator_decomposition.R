...
a_phi_DOC=c(1,10) # VARIATIONS OF TROPHIC_GROUP PARAMETERS
a_phi_FOM=c(10,100,1000) # VARIATIONS OF TROPHIC_GROUP PARAMETERS
a_phi_SOM=c(1,10,100) # VARIATIONS OF TROPHIC_GROUP PARAMETERS
...
for (i in 1:n_trophic_group_file){
  trophic_group_parameters$a_phi_DOC[trophic_group_parameters$trophic_group=="microbes"]=var_params$a_phi_DOC[i]
  trophic_group_parameters$a_phi_FOM[trophic_group_parameters$trophic_group=="microbes"]=var_params$a_phi_FOM[i]
  trophic_group_parameters$a_phi_SOM[trophic_group_parameters$trophic_group=="microbes"]=var_params$a_phi_SOM[i]
